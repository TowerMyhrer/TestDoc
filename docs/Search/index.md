...
Mal settes primært opp i oppsettet men kan overstyres i dette søkebildet. Det benyttes tilhørende mal som er valgt på denne siden.

## Søke i BRreg.no

For å søke fyller du ut søkekriterier og trykker knappen **søk**.

![Brreg søk](../media/search/brreg-menu-search.png)

Søket returnerer de 100 første hvis søkeresultatet er for stort så benytt flere søkekriterier.
...
Krysses det av for **Søk Underenheter** så vil man benytte organisajsonsnummeret til hovedenheten og vil få listet opp underenheter til hovedenheten i søkeresultatet.

## Avansert Søk

Hvis vi trykker på **Vis mer** for å utvide og se alle feltene i fanen så kommer de ut slik:
![BBrreg Avansert søk](../media/search/brreg-search-show-advanced-search.png)

Feltet **Kommunenr.**  lar deg søke kommunenummer.
Det er oppslag mot tabellen for kommuner. Informasjonen er hentet fra Kartverket.
...
Feltet **Reg i Foretaksregisteret** lar deg søke på de organisasjonene som er registrert i foretaksregisteret. Driver du med handel med litt størrelse må du være registrert i foretaksregisteret.
...
![BBrreg Avansert søk](../media/search/brreg-search-results.png)

Her kan vi stå på en linje og trykke på knappene Opprett Kunde og Opprett Leverandør

![BBrreg Avansert søk](../media/search/brreg-search-create-cust-vend.png)
